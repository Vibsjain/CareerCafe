  ...
  return (
    <div className="flex w-full justify-center items-center px-4">
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <p className="text-xl sm:text-2xl font-bold text-center text-[#eb924e] mb-2">
          One size rarely fits all - So we Avoid cookie cutter solution
        </p>
        <p className="text-xl font-bold mb-2 mt-4 bg-[#B2BFC8] text-center sm:text-justify p-2 rounded-3xl px-4">
          KYS - Know your Student
        </p>
        <p className="mb-8 text-md sm:text-xl font-bold text-justify sm:text-center mt-4 sm:mt-0">
        ...
        <p className="text-xl font-bold mb-2 mt-2 bg-[#B2BFC8] text-center sm:text-justify p-2 rounded-3xl px-4">
          Post Placement Support
        </p>
        <p className=" text-md sm:text-xl font-bold mb-2 text-justify sm:text-center mt-4 sm:mt-0">
