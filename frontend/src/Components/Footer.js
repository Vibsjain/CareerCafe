      ...
      <div className="mb-4 flex flex-row justify-center items-center w-full">
        ...
        <div className="sm:w-1/2 md:w-1/2 lg:w-1/3 pl-8">
          <div className="w-full flex flex-col justify-center items-center text-white text-center">
            <h3 className="text-3xl py-4 text-white mb-6">Navigate</h3>
            <ul>
              <li className="mb-2">
                <a
                  href="#"
        ...
        <div className="sm:w-1/2 md:w-1/2 lg:w-1/3 pl-8">
          <div className="w-full text-center">
            <h3 className="text-3xl py-4 text-white mb-6">Join Us On</h3>
            <div className="flex flex-row justify-center items-center">
                <a href="https://instagram.com/career.cafe" target="_blank"><img src={Instagram} className="w-[55px] h-[55px] rounded-full cursor-pointer m-4 transition-transform duration-500 hover:scale-125" /></a>
                <a href="https://instagram.com/career.cafe" target="_blank"><img src={Twitter} className="w-[55px] h-[55px] rounded-full cursor-pointer m-4 transition-transform duration-500 hover:scale-125" /></a>
            </div>
            <div className="flex flex-row justify-center items-center">
            <a href="https://t.me/career_cafe" target="_blank"><img src={Telegram} className="w-[55px] h-[55px] rounded-full cursor-pointer m-4 transition-transform duration-500 hover:scale-125" /></a>
            <a href="https://instagram.com/career.cafe" target="_blank"><img src={Facebook} className="w-[55px] h-[55px] rounded-full cursor-pointer m-4 transition-transform duration-500 hover:scale-125" /></a>
            </div>
          </div>
        </div>
      </div>
