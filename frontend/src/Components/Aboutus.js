...
export default function Aboutus() {
  return (
      <div className="flex flex-col justify-center items-center w-full text-center px-4 mt-12">
        <p className="text-5xl font-bold text-center text-[#07075F] mb-10">
        About Us
        </p>
        <p className="mb-8 text-md sm:text-xl font-bold text-justify sm:text-center">
        ...
        <p className="mb-8 text-md sm:text-xl font-semibold sm:font-bold text-justify sm:text-center">With an ever-improving team that supports the highest level of service delivered in the field of Placement Preparation, Career Cafe has created a niche that is unmatched.</p>
        <p className="mb-10 text-ms sm:text-xl font-semibold sm:font-bold text-justify sm:text-center">We groom and enrich your job skills, and make you ready for the corporate world via our optimized placement training courses. Our trainers have mastered the skill of bringing the best out of every student. Throughout the course, our trainers helps the students identify their strengths and weaknesses and groom them to improve their performances.</p>
      </div>
  );
}
